...
print('Processing CWRU Bearing signal')
...
rawData = 'C:/Bearings/Datasets/CWRU/bearing270.csv'    # Raw data to Load
...
df = read_csv(rawData, header=0)                    # Read raw signal file
